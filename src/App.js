...
import PagesGamesList from "./client_comps/pagesGameList/pageGamesList";
import GameInfo from "./client_comps/gamesInfo/gameInfo";
  ...
  return (
    ...
    {/* Routes of header what to show client or admin header... */}
      ...
      <Routes>  
        ...
        <Route path="/category/:catName" element={<PagesGamesList />} />
